package com.example.petfriends.ui.custom
...
class CustomInputForm:AppCompatEditText, View.OnTouchListener {
    ...
    private fun textChangeListener() {
        addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                if(s.toString().isEmpty()) error = "Can't Empty" else checkTextEmail(s)
            }
        })
    }
